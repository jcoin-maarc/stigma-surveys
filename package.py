...
VERSION = "2.0"
DATASETS = [
    {"name": "survey1", "filename": "omnibus_survey1_2020-02_072821"},
    {"name": "survey2", "filename": "omnibus_survey2_2020-04_072821"},
    {"name": "survey3", "filename": "omnibus_survey3_2020-06_072821"},
    {"name": "survey4", "filename": "omnibus_survey4_2020-10_072821"},
...
for dataset in DATASETS:
    df = (
        pd.read_csv(
            f'data/protocol1-omnibus/csv/{dataset["filename"]}.csv', dtype="object"
        )
    ...
    schema = Schema.from_descriptor(
        f'metadata/schemas/{dataset["filename"]}-schema.yaml'
    )
    ...
    rsrc = Resource(
        df, name=dataset["name"], schema=schema, profile="tabular-data-resource"
    )
